...
Preparing files to run Variance components estimation.
...
# Ped file with iid
ped_iid <- read.csv("/home/bambrozi/2_CORTISOL/RawFiles/Pedigree/bruno_ped.iid.csv", header = F)

# Ped file with cid
ped_cid <- read.csv("/home/bambrozi/2_CORTISOL/RawFiles/Pedigree/bruno_ped.id.csv", header = F)

# Genotype file with cid
geno <- read.table("/home/bambrozi/2_CORTISOL/Geno_files/genoplink.ped")

#Asking which geno$V2 are present in eq_ids
all(geno$V2 %in% eq_ids$cdn_id)
