...
Use this parameter file to generate **renf90.par** and than run PREGSF90 to run renf90.par and perform the Quality Control.
...
The parameter card above, will be used with the program **preGS90** to generate the Clean Genotype files after Quality Control.

We can copy the same parameter card above and create the following parameter card:
...
Now we are going to run the parameter card above to generate the Variance Components that will be placed in the file: 
...
#### Running renf90.par for Quality Control

#### Running renf90.par for GEBV estimation

#### Running renf90.par for GWAS
...
## Prediction of GEBV with ssGBLUP
...
<img src="image125.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">
...
I was reading BLUPF90 manual to discover how to get the GWAS
