...
min_pval_per_window <- win_allsnp_pval %>%
  group_by(windows) %>%
  summarise(min_p_value = min(p_value, na.rm = TRUE)) %>%
  ungroup()
...
<font color="blue">/home/bambrozi/2_CORTISOL/GPROFILER/BLUPF90_GWAS/keep_all_pheno_windows</font>

Bellow the data inserted in g:PROFILER
<img src="image199.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">

Bellow we can find the output for g:Profiler online

<img src="image198.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">

```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/gProfiler_btaurus_2025-02-12_6-30-31 p.m.__intersections.csv")
