...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/w10_snp_rsid_snpvar_03.csv")
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_genes_w.csv")
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_qtl_w_clean.csv")
...
<img src="image183.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">
...
<img src="image184.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">
...
<img src="image185.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">
...
<img src="image186.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">
...
<img src="image187.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">
...
<img src="image188.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_enrich_qtl_genome_name_w.csv")
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_enrich_qtl_genome_type_w.csv")
