...
/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/bruno_gntps_iid
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/w10_snp_rsid_snpvar_01.csv")
...
common_SNP_05 <- intersect(pvalue$SNP_name, w05$SNP_name)

common_SNP_01 <- intersect(pvalue$SNP_name, w01$SNP_ID)

common_SNP_01
common_SNP_05

# Assuming common_SNP_05 is your original object
common_SNP_05 <- c(common_SNP_05[1], common_SNP_05[2], NA, NA, common_SNP_05[3])


comparison <- cbind(common_SNP_01, common_SNP_05)

write.csv(comparison, "/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/window_10/comparison_snp_01_05_pvalue.csv")
```
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/comparison_snp_01_05_pvalue.csv")
...
**For GENES**
Because this file has 1,608 rows we'll not show here, but you can take a look in the file:
*/home/bambrozi/2_CORTISOL/GALLO/GWAS_BLUPF90/windows10/out_genes_w01.csv*

**FOR QTLs**
Because this file has 7,347 rows we'll not show here, but you can take a look in the file:
*/home/bambrozi/2_CORTISOL/GALLO/GWAS_BLUPF90/windows10/out_qtl_w_01_clean.csv*
...
**QTL type**
<img src="image193.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">

**QTL name by type**
<img src="image194.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_enrich_qtl_genome_name_w01.csv")
...
<img src="image195.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">  

**Enrichment by QTL_type** (enrichment processes performed for the QTL classes)
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_enrich_qtl_genome_type_w01.csv")
...
<img src="image196.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;"> 


## Match Significant p-value and Windows variance bigger than 0.5%
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/pvalue_windowsVar_match.csv")
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/w_allele_freq.csv")
