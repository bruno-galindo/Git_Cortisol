...
<font color="blue">/home/bambrozi/2_CORTISOL/RawFiles/Pedigree</font>
okok
```{bash eval=FALSE}
...
<font color="blue">/home/bambrozi/2_CORTISOL/RawFiles/Genotypes</font>
...
<ul>
<li> /home/bambrozi/2_CORTISOL/RawFiles/Genotypes/bruno_gntps.txt  
<li> /home/bambrozi/2_CORTISOL/RawFiles/Pedigree/bruno_ids.csv  
<li> /home/bambrozi/2_CORTISOL/GWAS/BLUPF90/bruno_gntps_iid **(this file has 252 individuals)**  
</ul>
...
<font color="blue">/home/bambrozi/2_CORTISOL/RawFiles/SNP_map</font>  
okok
```{r eval = FALSE}
...
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/renum_QC.par</font>
...
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/renf90_DataClean.par</font>
...
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/renf90_VarCompEst.par</font>
...
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/blupf90.log</font>
...
To do this, I'll: 
<ul>
<li> **Keep** the Phenotype_FixEff file from the previous analysis with records for **252 individuals**
...
<font color="red">In this read_me file we performed a ssGWAS but keeping the phenotype and fixed effect information for all 252 individuals, only reducing the number of individuals for the Genotype file.</font>.
...
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno/renum_QC.par</font>
...
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno/renf90_DataClean.par</font>
...
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno/renf90_ssGWAS1_Ginv.par</font>
...
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno/renf90_ssGWAS2_SNPeff.par</font>
...
<img src="image129b.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">


We will use the file <font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno/**chrsnp_pval**</font> to get the p-values for the SNPs in the windows (that explain more than 0.5% of additive genetic variance)
...
<img src="image200.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">

## BLUPF90+ WINDOWS

To perform Window approach on Blupf90+ I copied all files in: 
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno</font>
to:
<font color="blue">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno/windows_10</font>
I did this because I'm not sure about which files the postGSf90 needs to run, so I duplicate the whole directory, and I will change only the file **renf90_ssGWAS2_SNPeff.par** name for **renf90_ssGWAS2_SNPeff_W_10.par** and change the options to perform the window approach.

### Running renf90_ssGWAS2_SNPeff_W_10.par for GWAS (WINDOWS)
...
<ul>
<li> If windows size is 20, the proportion of variance assigned to SNP 1 is calculated from SNP 1 to 20, for SNP 2 it goes from 2 to 21
</ul>
<li> column 4: SNP
<li> column 5: Chromosome
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/snpID_w05_rsid_snpvar.csv")
...
### Finding p-values for each SNP in the window

To bring the p-value for each snp in the window we need to use files from different approachs:
<ul>
<li> **chrsnpvar**: <p style="color:blue;">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno/windows_10/chrsnpvar</p>
<ul>
<li> which contains the variance explained by each window. This file is from windows approach
</ul>
<li> **chrsnp_pval**: <p style="color:blue;">/home/bambrozi/2_CORTISOL/GWAS/BLUPF90/EXTREME_PHENO/keep_all_pheno/chrsnp_pval</p>
<ul>
<li> which contains the p-value for each snp. This file is **not** from windows approach. Is for the approach which considers each SNP individually (beside fit all SNPs at the same time)
</ul>
</ul>
...
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/pval_for_each_snp_in_window.csv")
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_genes.csv")
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_qtl_clean_UNIQUE.csv")
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/out_qtl_clean.csv")
...
# g:PROFILER - 0.5% Windows - BLUPF90+ 

This output are in this directory:
<font color="blue">/home/bambrozi/2_CORTISOL/GPROFILER/BLUPF90_GWAS/keep_all_pheno_windows/smallest_snp_pvalue_per_window</font>

Bellow the data inserted in g:PROFILER
<img src="image199b.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">

Bellow we can find the output for g:Profiler online

<img src="image198b.png" alt="My Image" style="display: block; margin-left: auto; margin-right: auto;">

```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/gProfiler_btaurus_2025-02-14_11-00-34 a.m.__intersections.csv")
...
```{r echo=FALSE}
# Read the CSV file into a data frame
data <- read.csv("C:/Users/galin/OneDrive - University of Guelph/0.Post doc/4_Cortisol/Git_Cortisol/gProfiler_btaurus_2025-02-14_11-00-34 a.m.__intersections_gene_name.csv")
